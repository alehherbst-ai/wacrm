    ...
    <>
      ...
      <aside
        className={cn(
          ...
          // The transition switches from transform to width here, so
          // collapsing animates instead of snapping.
          // `shrink-0` pins the rail to exactly its declared width, so a
          // wide page can never squeeze it into a half-collapsed state.
          "lg:static lg:z-0 lg:shrink-0 lg:translate-x-0 lg:transition-[width] lg:duration-200",
