...
export const RATE_LIMITS = {
  ...
  /** Starting a thread from a typed number. Each call is a live
   *  WhatsApp lookup for an arbitrary number, so this doubles as the
   *  brake on using the inbox as a "is this number on WhatsApp?"
   *  enumeration oracle. 20/min is far above hand-typing one number at
   *  a time and far below anything worth scripting. */
  startConversation: { limit: 20, windowMs: 60_000 },
